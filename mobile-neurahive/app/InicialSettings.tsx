  ...
  return (
    ...
    >
      <View style={styles.content}>
        <Text style={styles.title}>Olá Usuário, vamos configurar o sistema antes de prosseguir?</Text>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.description}>
            O Acesso será utilizado para definir a área de atuação dos agentes e as permissões para acessá-los, 
            você poderá criar novos acessos posteriormente.
          </Text>
        </View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.checkboxContainer}>
            <Checkbox
              ...
              onValueChange={(value) => setClearChats({...clearChats, month: value})}
        ...
        <View style={styles.section}>
          ...
          <View style={styles.checkboxContainer}>
            <Text style={styles.checkboxLabel}>Carregue o arquivo de temas e respostas</Text>
          </View>
          <Text style={styles.fileInfo}>formatos válidos: tls.csv</Text>
          <Text style={styles.description}>
            A Base de conhecimento é de onde estas agentes irão se basear para fornecer respostas para os usuários, 
            carregue uma base válida para continuar, você poderá carregar novas posteriormente.
          </Text>
        </View>
        ...
        <View style={styles.footer}>
          <Text style={styles.footerText}>Início | Agentes | Usuários | Questores | Perfil</Text>
        </View>
      </View>
    </ScrollView>
  );
